...
export default function MappingDialog({ open, onOpenChange, type, config, onConfigChange, unmappedItems }: MappingDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-full md:max-w-4xl h-full md:h-[80vh] w-full flex flex-col md:rounded-lg">
                <DialogHeader>
